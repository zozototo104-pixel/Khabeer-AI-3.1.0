...
1. القرارات/المخاطر/المخالفات/نتائج الخبراء الرسمية المعتمدة تؤخذ من الجداول الحالية ولا تُخترع.
2. المهام الرسمية المسجلة تؤخذ من "المهام الحالية" كما هي.
3. إذا ورد في نص الاجتماع تكليف صريح باسم شخص، مثل: "محمد مكلف بكذا" أو "على محمد متابعة كذا" أو "نكلّف محمد بكذا"، فاستخرجه ضمن draftAssignments حتى لو لم يكن موجوداً في المهام الحالية.
4. لا تستبدل الاسم الصريح بجهة عامة مثل "فريق الرقابة" أو "وحدة المتابعة" إلا إذا كانت هذه الجهة هي المذكورة نصاً.
5. إذا كان التكليف مستنتجاً من ضمير بعد ذكر اسم في الجملة السابقة، ضعه في draftAssignments مع sourceType = "INFERRED_CONTEXT".
6. إذا لم يظهر اسم مكلف بوضوح، اجعل assignee = "غير محدد" ولا تخترع اسماً.
7. لا تستخدم جداول Markdown داخل النصوص؛ أرجع JSON فقط، وستتكفل الواجهة بعرضه.
