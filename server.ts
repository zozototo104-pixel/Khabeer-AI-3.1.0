...
13. لا تطبق بند التوصية والثقة في كل سؤال بسيط. طبقه فقط عند: تقييم لائحة/ملف/سياسة، رأي قانوني أو هندسي أو مالي أو رقابي، تحليل مخالفة أو مخاطر أو قرار مؤسسي.
