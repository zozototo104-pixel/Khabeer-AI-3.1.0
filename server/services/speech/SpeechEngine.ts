...
export class SpeechEngine {
  ...
  private lastPublishedProbe: Map<string, { serial: number; key: string; similarity: number; at: number }> = new Map();
  ...
  public disposeSession(sessionId: string): void {
    ...
    this.speechSerial.delete(sessionId);
    this.recentVerifiedProbe.delete(sessionId);
    this.lastPublishedProbe.delete(sessionId);
  }
